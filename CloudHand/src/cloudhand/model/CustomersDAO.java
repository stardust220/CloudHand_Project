...
public class CustomersDAO implements DAOInterface<String, Customer> {
    ...
    @Override
    public void insert(Customer c) throws CHException {
        if (c == null) {
        ...
        try (Connection connection = RDBConnection.getConnection();//1. 2. 取得連線
            ...
            throw new CHException("客戶新增失敗", ex);
    ...
    @Override
    public void delete(Customer c) throws CHException {
        if (c == null) {
        ...
        try (Connection connection = RDBConnection.getConnection();//1. 2. 取得連線
            ...
            throw new CHException("客戶刪除失敗", ex);
        }
    }

    @Override
    public void update(Customer c) throws CHException {
        if (c != null) {
            //JDBC update
            try (Connection connection = RDBConnection.getConnection();//1. 2. 取得連線
                ...
                throw new CHException("客戶修改失敗", ex);
            }
        } else {
    ...
    @Override
    public Customer get(String id) throws CHException {
        Customer c = null;
        try (Connection connection = RDBConnection.getConnection(); //1. 2. 取得連線
            ...
            throw new CHException("查詢客戶失敗!", ex);
        }

    }

    public List<Customer> getAll() throws CHException {
        ...
        try (Connection connection = RDBConnection.getConnection(); //1. 2. 取得連線
            ...
            throw new CHException("查詢全部客戶失敗!", ex);
        }
