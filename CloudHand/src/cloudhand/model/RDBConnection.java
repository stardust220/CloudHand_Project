...
public class RDBConnection {
    ...
    static {
        ...
        try {
            ResourceBundle bundle = ResourceBundle.getBundle("cloudhand.model.JDBC");
        ...
        if (data_source==null) data_source = "jdbc/cloudhand";
        
        if (driver==null) driver = "com.mysql.jdbc.Driver";
        if (url==null) url = "jdbc:mysql://localhost:3306/CloudHand?zeroDateTimeBehavior=convertToNull";
    ...
    static Connection getConnection() throws CHException {
        DataSource ds = null;
